...
public class PaintballMain extends javax.swing.JFrame {
    ...
    private void oneVOne() {
        ...
        for (int i = 0; i < team[1].length; i++)
        {
            ...
            team[2][i] = new Player(2, new BreadBrain());
        }
    ...
    {
        Brain[] players = {new DumbBaseCharger(), new BreadBrain(),new RandoBot(), 
            new RandomWalker(), new Shooter(), new Spinner(), new Sprinkler()};
